#!/usr/bin/env python3
"""
Qdrant Hybrid Benchmark Script — MSMARCO Splade, Concurrency Sweep
...
OUTPUT_EXCEL = os.path.join(
    WORK_DIR,
    f"bench_qdrant_msmarco_splade_concurrency_{datetime.now().strftime('%Y%m%d_%H%M%S')}.xlsx"
)
...
def write_excel(rows: list, output_path: str):
    ...
    ws = wb.active
    ws.title = "Qdrant MSMARCO Splade Concurrency"
...
def main():
    print("=" * 60)
    print("Qdrant Splade Benchmark — MSMARCO Concurrency Sweep")
