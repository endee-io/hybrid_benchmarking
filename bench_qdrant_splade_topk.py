#!/usr/bin/env python3
"""
Qdrant Hybrid Benchmark Script — Splade, Top-K Sweep
...
OUTPUT_EXCEL = os.path.join(
    WORK_DIR,
    f"bench_qdrant_splade_topk_{datetime.now().strftime('%Y%m%d_%H%M%S')}.xlsx"
)
...
def main():
    print("=" * 60)
    print("Qdrant Splade Benchmark — Top-K Sweep")
