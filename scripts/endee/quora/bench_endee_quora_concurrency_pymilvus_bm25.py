#!/usr/bin/env python3
"""
Endee Hybrid Benchmark Script — Concurrency Sweep
...
OUTPUT_EXCEL = os.path.join(
    WORK_DIR,
    f"bench_endee_concurrency_{datetime.now().strftime('%Y%m%d_%H%M%S')}.xlsx"
)
...
def write_excel(rows: list, output_path: str):
    ...
    ws = wb.active
    ws.title = "Endee Concurrency Sweep"
...
def main():
    print("=" * 60)
    print("Endee Hybrid Benchmark — Concurrency Sweep")
