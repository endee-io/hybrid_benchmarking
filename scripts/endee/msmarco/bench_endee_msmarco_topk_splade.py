#!/usr/bin/env python3
"""
Endee Hybrid Benchmark Script — MSMARCO Splade, Top-K Sweep
...
OUTPUT_EXCEL = os.path.join(
    WORK_DIR,
    f"bench_endee_msmarco_splade_topk_{datetime.now().strftime('%Y%m%d_%H%M%S')}.xlsx"
)
...
def write_excel(rows: list, output_path: str):
    ...
    ws = wb.active
    ws.title = "Endee MSMARCO Splade Top-K"
...
def main():
    print("=" * 60)
    print("Endee Splade Benchmark — MSMARCO Top-K Sweep")
