#!/usr/bin/env python3
"""
Endee Hybrid Benchmark Script — MSMARCO, Top-K Sweep
...
OUTPUT_EXCEL = os.path.join(
    SCRIPT_DIR,
    f"bench_endee_msmarco_topk_{datetime.now().strftime('%Y%m%d_%H%M%S')}.xlsx"
)
...
def main():
    print("=" * 60)
    print("Endee Hybrid Benchmark — MSMARCO Top-K Sweep")
