#!/usr/bin/env python3
"""
Qdrant Hybrid Benchmark Script — MSMARCO, Concurrency Sweep
...
OUTPUT_EXCEL = os.path.join(
    WORK_DIR,
    f"bench_qdrant_msmarco_concurrency_{datetime.now().strftime('%Y%m%d_%H%M%S')}.xlsx"
)
...
def write_excel(rows: list, output_path: str):
    ...
    ws = wb.active
    ws.title = "Qdrant MSMARCO Concurrency"
...
def main():
    print("=" * 60)
    print("Qdrant Hybrid Benchmark — MSMARCO Concurrency Sweep")
