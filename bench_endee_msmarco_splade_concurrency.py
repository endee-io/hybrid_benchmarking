#!/usr/bin/env python3
"""
Endee Hybrid Benchmark Script — MSMARCO Splade, Concurrency Sweep
...
OUTPUT_EXCEL = os.path.join(
    WORK_DIR,
    f"bench_endee_msmarco_splade_concurrency_{datetime.now().strftime('%Y%m%d_%H%M%S')}.xlsx"
)
...
def write_excel(rows: list, output_path: str):
    ...
    ws = wb.active
    ws.title = "Endee MSMARCO Splade Concurrency"
